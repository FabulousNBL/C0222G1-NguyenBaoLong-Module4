...
import com.example.casestudy.service.employee.impl.UserDetailsServiceImpl;
...
//        String password = bCryptPasswordEncoder.encode("123123");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/home", "/employee/list", "/customer/list")
                .access("hasAnyRole('ROLE_MEMBER', 'ROLE_ADMIN')");

        http.authorizeRequests()
                .antMatchers("/contract/list", "/employee-rest/*")
